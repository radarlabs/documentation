...
- On `country.passed == false` or `state.passed == false`: "Unable to verify your location. Please make sure you're in a permitted area and try again."
- On `proxy == true`: "Unable to verify your location. Please disconnect from any VPNs or proxy servers and try again."
