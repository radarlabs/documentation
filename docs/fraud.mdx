...
<Alert alertType="info">
  Radar periodically rotates SSL certicates while making sure that the public keys remain static. You will receive ample notice if Radar needs to rotate the public keys.
</Alert>
