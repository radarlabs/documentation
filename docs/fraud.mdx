...
From there, [integrate the SDK](/documentation/sdk), complete the steps below, and call `Radar.trackVerified()` or `Radar.startTracking()`. Radar will perform fraud and jurisdiction checks as described below.
