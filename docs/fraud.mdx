...
<Alert alertType="info">
  Once the Play Integrity dependency has been added to your Android Project, your Radar Project must enable the **Android Play Integrity API** feature. This feature is enabled on the [Settings page](https://radar.com/dashboard/settings) under the Fraud tab.
</Alert>
