...
Additionally, you can configure buffer zones for different states. If buffer zones are configured, `user.region.inBufferZone` indicates whether the user is within the buffer zone.
