...
Additionally, you can configure per-state buffer zones. If buffer zones are configured, `user.state.withinBuffer` indicates whether the user is within the buffer zone.
