...
Use the map matching API to snap points collected along a route to roads that were most likely traveled on. Returns a clean path and matched road information.
