...
## Traffic
Radar's routing APIs incorportate historic traffic data from the past 6 months, estimating current traffic conditions by day-of-week and time-of-day. For information about traffic coverage by country see the [Coverage](/maps/routing#coverage-1) table below. If you want to leverage real-time traffic, contact your customer suuccess manager to enable live traffic on your account.
