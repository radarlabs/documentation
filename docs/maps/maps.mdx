...
To use Radar Maps, simply initialize the Radar SDK with your publishable key, and give a starting position and container to render the map into.
...
In addition, there are a few options specfic to Radar
...
|`useIP` |`false` |boolean |Use the IP location of the device as the initial center point for the map. <br /> _Additional API usage applies for the use of [IP Geocode](/documentation/api#ip-geocode)._|
