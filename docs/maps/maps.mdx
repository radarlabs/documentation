...
| `style` | `radar-default-v1` | `radar-default-v1`, `radar-light-v1`, `radar-dark-v1`, `radar-satellite-v1`, `radar-hybrid-v1` | The style of the map. See the [Styles](/maps/maps#styles) section below for more details. |
...
<table className="full-width-table">
  ...
  <tbody>
    ...
    <tr>
      <td className="no-wrap"><code>radar-satellite-v1</code></td>
      <td style={{ width: "400px" }}><img width="400" src="https://images.ctfassets.net/f2vbu16fzuly/5i3mYUXQ0wwO98Pc0dX3N7/44b2d6583e533f1676c2e42ee7350c68/satellite.png" /></td>
      <td>A map style featuring detailed satellite imagery. Available on Enterprise plans.</td>
    </tr>
    <tr>
      <td className="no-wrap"><code>radar-hybrid-v1</code></td>
      <td style={{ width: "400px" }}><img width="400" src="https://images.ctfassets.net/f2vbu16fzuly/5oKN5MDDTROttnqVEUT6g4/14f2765fbef1212b5dff64df3b2c0289/hybrid.png" /></td>
      <td>A map style showcasing both satellite imagery and features such as roads. Available on Enterprise plans.</td>
    </tr>
  </tbody>
</table>
...
Display a Radar Map with an interactive globe projection.
...
<body>
  ...
  <script>
    ...
    const map = new Radar.ui.map({
      ...
      style: 'radar-default-v1',
      zoom: 2,
      minZoom: 0, // allow globe to zoom out
      center: [-73.9910078, 40.7342465],
    });

    // set projection on load
    map.on('style.load', () => {
      map.setProjection({
...
const RadarMap = () => {
  ...
  return <div id="map" style={{ width: '100%', height: '100vh', position: 'absolute' }} />;
};
...
To create a map on flutter, add [flutter-maplibre-gl](https://github.com/maplibre/flutter-maplibre-gl) to your flutter project.

Then, add assets for the Radar logo and optionally for a marker. You can download assets [here](/img/radar-map-assets.zip).

Finally, add ` MaplibreMap` with a Radar style URL that includes your publishable key:
...
Refer to an our [Radar flutter map demo](https://github.com/radarlabs/radar_flutter_maps_demo/tree/main) for more information.
...
To use Radar Maps with your existing Google Maps implementation, see our [Migration SDK](/maps/migration-sdk) for more details.
