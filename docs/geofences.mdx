...
To create geofences via CSV import, go to the [Geofences page](https://radar.com/dashboard/geofences) and click the _Import_ button. Then, select a CSV to upload.
