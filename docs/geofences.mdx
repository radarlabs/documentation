...
Operating hours can be set on individual geofences via [CSV import](https://radar.com/documentation/geofences#csv-import), the [API](https://radar.com/documentation/api#upsert-a-geofence), or in the *Advanced* section of the geofence create and edit pages.
