...
```json
description,tag,externalId,type,radius,mode,coordinates,enabled,metadata,stopDetection,disableAfter,deleteAfter,userId
...
"Stopped Empire State Building",stopped,store,456,circle,50,,"[-73.9878531,40.7484445]",true,,true,,,
