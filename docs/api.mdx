...
### Domain Restrictions
Additionally, you can restrict domains that use your API keys. You can change this on the [settings](https://radar.com/dashboard/settings/#website-restrictions) page

Example valid URLs:
- Any URL in a single domain: **https://example.com** or **example.com**
...
- A domain and all its subdomains, using a wildcard (\*) asterisk: **https://example.com** and **https://\*.example.com**
