...
Additionally you can acquire turn by turn directions (currently in beta) by specifying additional query parameters.

- **`detailed`** (boolean, optional): Specifies whether to return turn by turn directions in the response. Defaults to `false`.
