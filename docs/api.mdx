...
<span className="badge badge--danger">GET</span> <code>https://api.radar.io/v1/settings</code>
...
<span className="badge badge--danger">PATCH</span> <code>https://api.radar.io/v1/settings</code>
