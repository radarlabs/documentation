...
- **`mode`** (string, optional): The [travel mode](/api#route-distance). A string, one of `car`, `truck`, `foot`, and `bike`.
...
- **`modes`** (string, required): The [travel modes](/api#route-distance). A string, comma-separated, including one or more of `car`, `truck`, `foot`, and `bike`.
...
- **`mode`** (string, required): The travel mode. A string, one of `car`, `truck`, `foot`, and `bike`.
- **`units`** (string, optional): The distance units. A string, `metric` or `imperial`. Defaults to `imperial` if not provided.
...
- **`mode`** (string, optional): The travel mode. A string, one of `car`, `truck`, `foot`, and `bike`. Defaults to `car`.
