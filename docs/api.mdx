...
A user ID needs to be provided for a trip to update based on client-side tracking. A destination needs to provided for a trip to generate ETA updates. Including these parameters is strongly recommended when applicable.
