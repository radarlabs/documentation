...
- **`externalIds`** (string, options) Retrieves trips by unique IDs. A string, comma-separated including one or more IDs. This parameter overrides the `externalId` parameter.  
