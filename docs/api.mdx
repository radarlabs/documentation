...
- **`geometry`** (string, optional): The geometry of the route in [GeoJSON](http://geojson.org/) format. A string with value `linestring`. Defaults to not return the geometry.
