...
- **`accuracy`** (number, required): The accuracy of the user's current latitude and longitude, in meters. A number greater than 0. Used when evaluating [geofence events](/documentation/geofences#confidence-and-accuracy) and event confidence.
