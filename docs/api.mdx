...
<Alert alertType="info">
  The directions API is currently in beta. Contact your customer success manager for early access.
</Alert>
...
- **`locations`** (string, required): List of up to 25 coordinates to visit in order. A pipe-delimited string in the format `latitude0,longitude0|latitude1,longitude1|...`.
- **`mode`** (string, optional): The travel mode. A string with a value `foot`, `bike`, or `car`. Defaults to `car`.
...
```bash
curl "https://api.radar.io/v1/route/directions?locations=40.734250,-73.990927|40.732957,-73.992424|40.733756,-73.994281&mode=car&units=imperial" \
  -H "Authorization: prj_live_pk_..."
```
      ...
      "legs": [
        {
          ...
          "geometry": {
            "polyline": "mafulAnn`clChKxAhCF`CJdg@vGtB\\|BZpf@`HhC^yArEoZj`A"
          },
          "distance": {
            "value": 1033.4646,
            "text": "0.2 mi"
        ...
        },
        {
          ...
          "geometry": {
            "polyline": "koculApncclCaTdq@aAzCqA~DmVpv@"
          },
          "distance": {
            "value": 587.27036,
            "text": "587.3 ft"
...
<Alert alertType="info">
  The optimize API is currently in beta. Contact your customer success manager for early access.
</Alert>
...
- **`locations`** (string, required): List of up to 10 coordinates to visit. A pipe-delimited string in the format `latitude0,longitude0|latitude1,longitude1|...`. The first location should be the origin of the route, and the last location should be the final destination.
- **`mode`** (string, optional): The travel mode. A string with a value `foot`, `bike`, or `car`. Defaults to `car`.
- **`units`** (string, optional): The distance units. A string, `metric` or `imperial`. Defaults to `imperial`.
