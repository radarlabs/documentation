...
- **`path`** (array, required): A list of coordinate objects along a route to be snapped.
  ...
  - Objects may optionally include either or both an ISO date string and an accuracy value in meters for that coordinate `{coordinates: 'latitude,longitude', createdAt: 'iso date string', accuracy: 'value in meters'}`
...
curl "https://api.radar.io/v1/route/match" \
  ...
  -X POST \
  -d '{"path": [{"coordinates": "40.754231505412264,-73.98465161242224", "createdAt": "2024-03-29T20:47:49Z"}, {"coordinates": "40.73988226756973,-73.9950818342906", "createdAt": "2024-03-29T20:49:02Z"}], "mode": "car"}'
```
