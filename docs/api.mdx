...
```bash
curl https://api.radar.com/v1/users \
...
<span className="badge badge--info">POST</span> <code>https://api.radar.com/v1/track</code>
...
```bash
curl "https://api.radar.com/v1/track" \
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/context</code>
...
```bash
curl "https://api.radar.com/v1/context?coordinates=40.78382,-73.97536" \
  -H "Authorization: prj_live_pk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/geocode/forward</code>
...
```bash
curl "https://api.radar.com/v1/geocode/forward?query=20+jay+st+brooklyn+ny" \
  -H "Authorization: prj_live_pk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/geocode/reverse</code>
...
```bash
curl "https://api.radar.com/v1/geocode/reverse?coordinates=40.70390,-73.98670" \
  -H "Authorization: prj_live_pk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/geocode/ip</code>
...
```bash
curl "https://api.radar.com/v1/geocode/ip?ip=107.77.199.117" \
  -H "Authorization: prj_live_pk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/search/autocomplete</code>
...
```bash
curl "https://api.radar.com/v1/search/autocomplete?query=brooklyn+roasting&near=40.70390,-73.98670" \
  -H "Authorization: prj_live_pk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/search/users</code>
...
```bash
curl "https://api.radar.com/v1/search/users?near=40.78382,-73.97536&radius=1000&limit=10" \
  -H "Authorization: prj_live_sk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/search/geofences</code>
...
```bash
curl "https://api.radar.com/v1/search/geofences?tags=store&metadata[offers]=true&near=40.783826,-73.975363&radius=1000&limit=10" \
  -H "Authorization: prj_live_pk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/search/places</code>
...
```bash
curl "https://api.radar.com/v1/search/places?chains=starbucks&near=40.78382,-73.97779&radius=1000&limit=10" \
  -H "Authorization: prj_live_pk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/route/distance</code>
...
```bash
curl "https://api.radar.com/v1/route/distance?origin=40.78382,-73.97536&destination=40.70390,-73.98690&modes=foot,car&units=imperial" \
  -H "Authorization: prj_live_pk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/route/matrix</code>
...
```bash
curl "https://api.radar.com/v1/route/matrix?origins=40.78382,-73.97536&destinations=40.70390,-73.98690|40.73237,-73.94884&mode=car&units=imperial" \
  -H "Authorization: prj_live_pk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/users</code>
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/users/:id</code>
...
```bash
curl "https://api.radar.com/v1/users/56db1f4613012711002229f4" \
  -H "Authorization: prj_live_sk_..."
```
...
<span className="badge badge--danger">DELETE</span> <code>https://api.radar.com/v1/users/:id</code>
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/trips/:id</code>
...
```bash
curl "https://api.radar.com/v1/trips/299" \
  -H "Authorization: prj_live_sk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/trips</code>
...
```bash
curl "https://api.radar.com/v1/trips?active=true&destinationGeofenceTag=store&destinationGeofenceExternalId=123" \
  -H "Authorization: prj_live_sk_..."
```
...
<span className="badge badge--warning">PATCH</span> <code>https://api.radar.com/v1/trips/:id</code>
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/geofences</code>
...
```bash
curl "https://api.radar.com/v1/geofences" \
  -H "Authorization: prj_live_sk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/geofences/:id</code>
<br />
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/geofences/:tag/:externalId</code>
...
```bash
curl "https://api.radar.com/v1/geofences/56db1f4613012711002229f5" \
  -H "Authorization: prj_live_sk_..."
```
...
<span className="badge badge--warning">PUT</span> <code>https://api.radar.com/v1/geofences/:tag/:externalId</code>
...
```bash
curl "https://api.radar.com/v1/geofences/venue/2" \
  -H "Authorization: prj_live_sk_..." \
  -X PUT \
...
<span className="badge badge--danger">DELETE</span> <code>https://api.radar.com/v1/geofences/:id</code>
<br />
<span className="badge badge--danger">DELETE</span> <code>https://api.radar.com/v1/geofences/:tag/:externalId</code>
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/geofences/:tag/:externalId/users</code>
...
```bash
curl "https://api.radar.com/v1/geofences/venue/2/users" \
  -H "Authorization: prj_live_sk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/beacons</code>
...
```bash
curl "https://api.radar.com/v1/beacons" \
  -H "Authorization: prj_live_sk_..."
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/beacons/:id</code>
<br />
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/beacons/:uuid/:major/:minor</code>
...
```bash
curl "https://api.radar.com/v1/beacons/6109a4b16dbfe3de2cb03924" \
  -H "Authorization: prj_live_sk_..."
```
...
<span className="badge badge--info">POST</span> <code>https://api.radar.com/v1/beacons</code>
...
<span className="badge badge--warning">PUT</span> <code>https://api.radar.com/v1/beacons/:tag/:externalId</code>
...
```bash
curl "https://api.radar.com/v1/beacons/drive-thru/store123-beacon-1" \
  -H "Authorization: prj_live_sk_..." \
  -X PUT \
  -d "description=Beacon 1" \
  -d "type=ibeacon" \
...
<span className="badge badge--danger">DELETE</span> <code>https://api.radar.com/v1/beacons/:id</code>
...
```bash
curl "https://api.radar.com/v1/beacons/56db1f4613012711002229f4" \
  -H "Authorization: prj_live_sk_..." \
  -X DELETE
```
...
<span className="badge badge--success">GET</span> <code>https://api.radar.com/v1/settings</code>
...
```bash
curl "https://api.radar.com/v1/settings" \
  -H "Authorization: prj_live_sk_..." \
  -X GET
```
...
<span className="badge badge--warning">PATCH</span> <code>https://api.radar.com/v1/settings</code>
