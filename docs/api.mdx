...
- **`geofences`** (array): An array of the user's current geofences ordered by the time each geofence was entered, followed by the [confidence](/geofences#confidence-and-accuracy) of those entry events.
