...
Trips can also be created server-side or through integrations (e.g. Olo). Location updates with the specified `userId` from the [SDK](/sdk) will update the trip.
