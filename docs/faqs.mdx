...
- **Data access**: Access to specific data and pages across projects in an organization
  ...
  - *Geofence tags*: Access to geofences with specific tags. An empty list gives access to all geofences. To access a Geofence, both the *tag* and *externalId* access controls must be satisified.
  - *Geofence externalIds*: Access to geofences with specific externalIds. An empty list gives access to all geofences. To access a Geofence, both the *tag* and *externalId* access controls must be satisified. 
...
### Why are counts of active users different from counts tracked users?
