...
See the [SDK documentation](/sdk) and [Navigating location services tradeoffs between accuracy, frequency, and battery efficiency](ttps://radar.io/blog/navigating-location-services-tradeoffs-between-accuracy-frequency-battery-efficiency) for more information.
...
Yes, Radar supports location verification and fraud detection for gambling, media, payments, and more. First, you can use the [IP geocoding API](/documentation/api#ip-geocode) to detect a user's country or state based on IP address. You can check the `proxy` flag in the response to determine if the user is using a known proxy, VPN, data center, or Tor exit node.

Second, you can use [Regions](/documentation/regions) to detect a user's country or state based on latitude and longitude. On Android, you can check the [`location.isMock`](https://developer.android.com/reference/android/location/Location#isMock()) flag determine if the user is mocking their location.
...
For more information, see our [privacy policy](https://radar.io/privacy), our [commitment to privacy](https://radar.io/blog/our-commitment-to-privacy), and our [location data privacy checklist](https://radar.io/blog/location-data-privacy-checklist).
...
For more information, see our [location data privacy checklist](https://radar.io/blog/location-data-privacy-checklist).
...
Yes, Radar is CCPA-compliant and GDPR-compliant. For more information, see our [commitment to privacy](https://radar.io/blog/our-commitment-to-privacy).
