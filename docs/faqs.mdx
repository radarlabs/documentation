...
Additionally, you can restrict which websites can use your publishable API keys. You can add or modify available domains on the [settings](https://radar.com/dashboard/settings/#website-restrictions) page. Multiple entries are supported and can be confirmed with the selectable input field.
