...
#### Legend
 ...
 Icon | Description
--- | ---
<span style="font-size: 80%">⬤</span> | Good data quality and availability
...
--- | --- | --- | --- | ---
🇺🇸 US (consumer) | <span style="font-size: 80%">⬤</span> | <span style="font-size: 80%">⬤</span> | <span style="font-size: 80%">⬤</span> | <span style="font-size: 80%">⬤</span>
🇺🇸 US (logistics) | ◐ | ◐ | ◐ | <span style="font-size: 80%">⬤</span>
🇨🇦 CA (consumer) | ◐ | ◐ | ◐ | <span style="font-size: 80%">⬤</span>
🇨🇦 CA (logistics) | ◐ | ◐ | ◐ | <span style="font-size: 80%">⬤</span>
🇬🇧 UK (consumer) | ◐ | ◯ | ◐ | <span style="font-size: 80%">⬤</span>
🇬🇧 UK (logistics) | ◐ | ◯ | ◐ | <span style="font-size: 80%">⬤</span>
🌎 Other (consumer) | ◐ | ◯ | ◐ | <span style="font-size: 80%">⬤</span>
🌎 Other (logistics) | ◐ | ◯ | ◐ | <span style="font-size: 80%">⬤</span>
