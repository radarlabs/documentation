...
### What is Radar's data coverage for geocoding, search, and routing APIs?

The Radar team is constantly working to improve data coverage for our geocoding, search, and routing APIs.

The following table describes data coverage for geocoding, search, and routing APIs, for consumer use cases (e.g., store locator, address autocomplete) and logistics use cases (e.g., ride sharing, delivery).
...
&nbsp; | Coarse geocoding and autocomplete (regions) | Fine geocoding and autocomplete (address) | Places | Routing
--- | --- | --- | --- | ---
🇺🇸 US (consumer) | 🟢 | 🟢 | 🟢 | 🟢
🇺🇸 US (logistics) | 🟡 | 🟡 | 🟡 | 🟢
🇨🇦 CA (consumer) | 🟡 | 🟡 | 🟡 | 🟢
