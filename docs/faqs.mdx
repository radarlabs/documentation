...
- **Data access**: Access to specific data and pages across projects in an organization
  ...
  - *Geofence tags*: Access to geofences with specific tags. An empty list gives access to all geofences.
  - *Geofence externalIds*: Access to geofences with specific externalIds. An empty list gives access to all geofences.
    To access a Geofence, both the *tag* and *externalId* configurations must be satifified. 
