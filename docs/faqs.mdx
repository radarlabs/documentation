...
#### Mobile Restrictions
Furthermore, you can also restrict which mobile app can use your publishable key via the RadarSDK. You can add or modify available bundle IDs or package names on the [settings](https://radar.com/dashboard/settings/#mobile-restrictions) page. Multiple bundle IDs or package names are supported with the selectable input field. Mobile bundle IDs or package names cannot have wildcards (\*) and are case insensitive.
