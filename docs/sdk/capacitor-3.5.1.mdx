...
id: capacitor-3.5.1
description: Documentation for Capacitor Plugin v3.5.1 and Below
---
...
<Alert alertType="info">
  See trip tracking docs for Capacitor SDK versions older versions v3.5.2 and above <a href="/sdk/capacitor#trip-tracking">here</a>.
</Alert>
