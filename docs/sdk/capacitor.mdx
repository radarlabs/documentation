...
<Alert alertType="warning">
  Note that `Radar.initialize(this, publishableKey)` must be called before 
  `super.onCreate(savedInstanceState)` on Capacitor v4 and higher because of changes to 
  [plugin loading](https://capacitorjs.com/docs/updating/4-0#change-registerplugin-order).
</Alert>
