...
---- | ---- | --- | ---- | ----
**`NoPermissionsGranted`** | `kCLAuthorizationStatusNotDetermined` | `False` | * | *
**`ForegroundPermissionsGranted`** | `kCLAuthorizationStatusAuthorizedWhenInUse` | * | `False`| `True`
**`ForegroundPermissionsRejected`** | `kCLAuthorizationStatusDenied` | * | * | *
**`ForegroundPermissionsPending`** | `kCLAuthorizationStatusNotDetermined` | `True` | * | *
**`BackgroundPermissionsGranted`** |  `kCLAuthorizationStatusAuthorizedAlways` | * | * | *
**`BackgroundPermissionsRejected`** | `kCLAuthorizationStatusAuthorizedWhenInUse` | * | `True` | *
**`BackgroundPermissionsPending`** | `kCLAuthorizationStatusAuthorizedWhenInUse` | * | `False` | `False`
**`PermissionsRestricted`** | `kCLAuthorizationStatusRestricted` | * | * | *
