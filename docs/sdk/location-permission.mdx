...
Simplify your location permission requesting logic with Radar's SDK. 

Check out our [tutorial](/tutorials/building-better-location-permission-requesting) to implement location permission requesting.
...
For detailed implementation of linking the listener to your app's state/navigation management, check out our [tutorial](/tutorials/building-better-location-permission-requesting).
...
- **`backgroundPromptAvailable`**: A flag indicating whether the user has been prompted for background location permissions.
- **`inForegroundPrompt`**: A flag indicating if the user is currently in the prompt for granting foreground location permissions.
...
locationManagerStatus | locationManagerStatus | inForegroundPrompt | backgroundPromptAvailable | userRejectedBackgroundPermissions
--- | --- | --- | --- | ---
...
- **`inLocationPrompt`**: A flag indicating whether the user is currently inside the location permissions prompt UI.
...
locationManagerStatus | backgroundPermissionResult | shouldShowRequestPermissionRationaleBG | previouslyDeniedBackground | foregroundPermissionResult | inLocationPrompt | approximatePermissionsResult | shouldShowRequestPermissionRationaleFG | previouslyDeniedForeground 
--- | --- | --- | ---| --- | --- | --- | --- | --- 
**`NO_PERMISSIONS_GRANTED`** | `False` | * | * | `False` | `False` | `False` | `False` | `False` 
**`FOREGROUND_PERMISSION_GRANTED`** | `False` | * | `False` | `True` | * | * | * | *
**`FOREGROUND_PERMISSION_REJECTED`** | `False` | * | * | `False` | `False` | `False` | `False` | `True` 
**`FOREGROUND_LOCATION_PENDING`** | `False` | * | * | `False` | `True` | * | * | * 
**`BACKGROUND_PERMISSION_GRANTED`** | `True` | * | * | * | * | * | * | * 
**`BACKGROUND_PERMISSION_REJECTED`** | `False` | `False` | `True` | `True` | * | * | * | *
**`APPROXIMATE_PERMISSION_GRANTED`** | `False` | * | * | `False` | `False` | `True` | * | * 
**`FOREGROUND_PERMISSION_REJECTED_ONCE`** | `False` | * | * | `False` | `False` | `False` | `True` | *
