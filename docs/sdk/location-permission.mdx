---
sidebar_label: Location Permissions (beta)
title: Location Permissions (beta) Reference
---
...
<Alert alertType="warning">
  The <code>Radar.requestBackgroundLocationPermission</code> is temporarily disabled for <code>Objective-C</code> and <code>Swift</code> in version <code>3.14.0</code> as we refine our approach to not introduce spurious permission requirements for apps that don't use background location.
</Alert>
