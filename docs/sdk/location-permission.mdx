...
<Alert alertType="warning">
  The <code>Radar.requestBackgroundLocationPermission</code> is temporarily disabled for <code>Objective-C</code> and <code>Swift</code> in version <code>3.14.0</code> to enhance and refactor location permission request processes in upcoming releases.
</Alert>
