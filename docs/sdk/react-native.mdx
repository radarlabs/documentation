...
With the [conversion events API](/api#log-a-conversion-event), send a conversion event, such as a purchase or signup, to analyze alongside your app's location activity:
