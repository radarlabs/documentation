...
You can use our Expo plugin to take care of the native setup in an Expo app. Add `"react-native-radar"` to the `"plugins"` field in your `app.json`. Set plugin arguments to configure `react-native-radar` for your project. 
