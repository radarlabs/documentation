...
App lifecycle events are logged natively. No setup is required for the Android SDK while IOS instructions can be found in the [iOS SDK documentation](/sdk/ios). 
