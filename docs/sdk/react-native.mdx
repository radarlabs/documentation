...
On iOS, you must add [location usage descriptions](/sdk/ios#request-permissions) and the *location* and *fetch* background modes to your `Info.plist` if leveraging responsive or continuous tracking. Once this is complete add the SDK to your project, preferably using CocoaPods. 
</div>
