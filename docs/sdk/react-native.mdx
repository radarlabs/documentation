...
With the [conversion events API](/api#log-a-conversion-event), log a conversion event, such as a purchase or signup, to analyze alongside your app's location activity:
