...
Add the Radar android SDK to the `dependencies` section of your android app's `build.gradle` file. Ensure the Android SDK version matches the version of your Radar Flutter package.
