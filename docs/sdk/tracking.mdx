...
val trackingOptions = { ...presetContinuousAndroid, beacons: true }
Radar.startTrackingCustom(trackingOptions)
```
  </TabItem>
...
<img src={useBaseUrl("/img/dashboardRTO.png")} alt="Remote tracking options" />
