...
Include a value for `Privacy - Motion Usage Description` in your `info.plist`
To include location metadata information along with each track call, install the `RadarSDKMotion` companion module.
