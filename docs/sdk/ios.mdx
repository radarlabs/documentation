...
With the [custom events API](/api#create-a-custom-event), create a custom event, such as a conversion or purchase, to analyze alongside your app's location activity:
