...
With the [custom events API](/api#create-a-custom-event), create a custom event, such as a conversion or purchase, to analyze alongisde your app's location activity:
