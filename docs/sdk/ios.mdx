...
With the [conversion events API](/api#log-a-conversion-event), send a conversion event, such as a conversion or purchase, to analyze alongside your app's location activity:
