...
In Xcode, go to *File* > *Swift Packages* > *Add Package Dependency*. Enter `https://github.com/radarlabs/radar-sdk-ios-spm.git` for the *Package Repository URL*.
**Note:** This is a distict repository from `radarlabs/radar-sdk-ios` to reduce download size of the dependency.
