...
<Alert alertType="info">
  Only select <code>RadarSDK</code> unless you are also intending to use the location metadata feature. Refer to <a>sdk/ios#location-metadata</a> for more information
</Alert>
