...
You can remotely set SDK [tracking options](tracking) with either the default presets or a custom configuration. Remotely setting tracking options overrides any client-side specified tracking options.
