...
namespace MyProject
{
    public class Example
    {
        void Example ()
        {
            RadarSingleton.Initialize(new RadarSDKImpl()); // must be called from an Android or iOS project
...
See the [Xamarin Permissions docs](https://docs.microsoft.com/en-us/xamarin/essentials/permissions) to learn how to check and request permissions.
