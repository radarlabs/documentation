...
Tracking for the duration of a trip is started or updated by including tracking options in the trip start call:
...
If tracking was disabled before the trip started, it will stop after the trip ends. Otherwise, it will revert to the tracking options before the trip started:
