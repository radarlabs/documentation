...
<div className="alert alert-info">
  These are the docs for Android SDK v3.2. See docs for v3.1 <a href="/documentation/sdk/android-3.1">here</a>.
</div>
...
```kotlin
dependencies {
    implementation 'io.radar:sdk:3.2.+'
}
```
...
When your app starts, in application `onCreate()`, initialize the SDK with your publishable API key, found on the [Settings page](https://radar.io/dashboard/settings).
