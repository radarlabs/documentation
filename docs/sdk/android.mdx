...
<div className="alert alert-info">
  ...
  , the continuous preset starts a <a href="https://developer.android.com/guide/components/foreground-services">
    foreground service
  </a> with a notification while tracking.  When the foreground service with a notification is running, only foreground permissions are required for tracking. See the <a href="/documentation/sdk/tracking#android-foreground-service-options">
