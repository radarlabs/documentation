...
Tracking will stop after the trip ends if it was disabled before trip start. Otherwise, it will continue with the tracking options used before trip start:
