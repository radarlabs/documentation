...
<div className="alert alert-info">
  These are the docs for Android SDK v3.1. See docs for the latest version <a href={useBaseUrl('/sdk/android')}>here</a>.
</div>
...
<div className="alert alert-info">
  ...
  presets. See the{" "}
  <a href={useBaseUrl('/sdk/tracking')}>tracking options reference</a>.
</div>
...
<div className="alert alert-info">
  ...
  <a href={useBaseUrl('/trip-tracking')}>start a trip</a> if you haven't
  already.
</div>
