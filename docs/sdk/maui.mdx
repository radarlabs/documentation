...
Install the package from [NuGet](https://www.nuget.org/packages/RadarIO.MAUI/):

```bash
Install-Package RadarIO.MAUI
```
...
See the [MAUI Permissions docs](https://docs.microsoft.com/en-us/maui/essentials/permissions) to learn how to check and request permissions.
