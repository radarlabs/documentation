...
Radar offers analytics on trip data and location opt-in rates from users in your project. Analytics on trip data is grouped under the Trips tab, and analytics on location permission opt-in rates is grouped under the Permissions tab. Read more about Permissions [here](https://radar.io/documentation/faqs#location-permissions).
