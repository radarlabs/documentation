...
- **`Repeat customers`**: the total number of your users who have completed more than one trip. (like the other statistic cards, the number of repeat customers is affected by the filters set in the Filters section)
