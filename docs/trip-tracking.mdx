...
Radar offers analytics on trip data and location opt-in rates from [users](https://radar.com/documentation/api#users) in your project. [Analytics](https://radar.com/dashboard/analytics) on trip data can be found on the Analytics page and grouped under the Trips tab. Analytics on location permission opt-in rates is grouped under the Permissions tab. Read more about Permissions [here](https://radar.com/documentation/faqs#location-permissions).
