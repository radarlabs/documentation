...
To trigger an event when a trip delay is detected, navigate to the [Settings page](https://radar.com/dashboard/settings#trips-settings) and enable the `user.delayed_during_trip` event under *Trips* section.
