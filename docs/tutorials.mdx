...
- **[Detecting location-based fraud](/tutorials/detecting-location-based-fraud)**: Use the Radar [iOS SDK](/sdk) to detect location-based fraud.
- **[Analyzing the location context of customer interactions](/tutorials/analyzing-the-location-context-of-customer-interactions)**: Send custom events to the Radar platform using Radar's iOS and Android SDKs to analyze the location context of key customer interactions.
