...
- **[Detecting location-based fraud](/tutorials/detecting-location-based-fraud)**: Use the [web SDK](/sdk/web) and [IP geocoding API](/api#ip-geocode) to localize a website based on current country or city.
