...
- **[Building location permissions gathering](/tutorials/building-better-location-permission-gathering)**: Use the [iOS](/sdk/ios), [Android](/sdk/android) to collect and handle location permissions for your application.
