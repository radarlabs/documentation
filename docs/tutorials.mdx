...
- **[Analyzing where key customer interactions occur](/tutorials/analyzing-where-key-customer-interactions-occur)**: Send custom events using the [iOS](/sdk/ios) and [Android](/sdk/android) SDKs to analyze the location context of key customer interactions.
