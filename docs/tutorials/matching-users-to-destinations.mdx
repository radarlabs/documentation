...
In this tutorial, we show you how to use Radar's [Search Users] (https://radar.com/documentation/api#search-users) and [Distance Matrix] (https://radar.com/documentation/api#search-users) endpoints to find the nearest users to a known destination, sorted by travel time.
