...
In the field below entitled "Geofence tags (comma-separated)", input the tag of the geofence you created to trigger the increase in tracking frequency, `ramp-up`.
