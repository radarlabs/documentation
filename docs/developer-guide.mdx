...
- Leveraging location to power [in app experiences](blog/in-store-app-experiences)
- Using location to monitor incoming arrivals to a facility or store
- Using location to [trigger marketing messaging](blog/case-study-retailmenot)
