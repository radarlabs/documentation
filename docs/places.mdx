...
Places is available on the [Team](https://radar.io/pricing) plan and higher.

You can enable Places on the [Settings page](https://radar.io/dashboard/settings).
...
All place events have [confidence levels](#confidence), and places may have one or more [categories](#categories) and a [chain](#chains).
...
To map Radar chain slugs to custom IDs, set _Chain Mappings_ under _Places_ on the [Settings page](https://radar.io/dashboard/settings).
...
To map Radar chain slugs to custom metadata, set _Chain Metadata_ under _Places_ on the [Settings page](https://radar.io/dashboard/settings).
...
We recommend filtering events to specific categories or chains under _Places_ on the [Settings page](https://radar.io/dashboard/settings).
