...
To not track users at specific place categories in certain states, add the categories and the states in which they are to be blocked in under Places on the [Settings page](https://radar.com/dashboard/settings).

Note that Regions must be enabled on the project to have this setting.
