...
Radar curates POI data from multiple open and commercial datasets. Our database includes millions of places around the world, with coverage for major chains (like McDonald's or Walmart) and categories (like airports or stadiums), often with accurate polygon geometry and additional metadata like address or operating hours.

<img src="https://images.ctfassets.net/f2vbu16fzuly/5SOzJ3H2StLCXe7HOZ7Bwh/03eedca39bd2f018749d772764bdeca5/places_event.svg" className="hero-image--small" />
