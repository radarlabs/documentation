...
- **`radar:notificationRepeats`** (boolean, optional): Determines whether the notification should be delivered multiple times before the next notification sync. Defaults to `false`.
