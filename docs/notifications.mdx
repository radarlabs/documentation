...
With Radar [Conversions](/api#log-a-conversion), you can also retreive the source of an *opened_app* conversion. Within the *metadata* object of the [logged conversion](https://radar.com/documentation/sdk/ios#conversions), we will return a *conversion_source* with either 
...
Radar.logConversion(
  ...
  metadata: metadata
    ...
    let conversionSource = event?.metadata?["conversion_source"] as! String
    print("Conversion Source: \(conversionSource)")
}
```
