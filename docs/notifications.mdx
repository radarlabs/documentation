...
- **`radar:notificationSubtitle`** (string, optional): The title of the notification, displayed in bold.
- **`radar:notificationTitle`** (string, optional): The subtitle of the notification, displayed in bold.
- **`radar:notificationRepeats`** (boolean, optional): Determines whether the notification should deliver multiple times between subsequent notification syncs. Defaults to `false`.
