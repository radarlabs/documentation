...
Use Radar's on-premise notifications to display a notification when a user enters a geofence. Notifications work even with only foreground or <b>While Using the App</b> permissions!
...
Radar's on-premise notifications make use of location notification triggers on iOS. These triggers work with only foreground or <b>While Using the App</b> permissions. This feature is privacy-friendly and won't collect any location data or display notifications unless the user opens the app.
