...
Use this guide to test location tracking and event generation.
...
** Verification:**  Use the event details or [integration event logs](https://radar.com/dashboard/integrations/eventlogs) page to verify successful event delivery to integrations.
