...
<Alert alertType="info">
  The simulator is scoped to the environment you've selected in the left navigation (<i>Live</i> or <i>Test</i>). To avoid any production side effects, use the <i>Test</i> environment wiht the default user provided (<code>simulated-user-id</code>).
</Alert>
