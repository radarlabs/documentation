...
1. **Import your Geofences against Radar's places data.** Upon importing your geofences into Radar, select [chains](/places/chains) to match your geofences aganist. By default, Radar will search for [places](/places) for those chains within 10 kilometers (~6 miles) of each Geofence. The search radius can be configured as an advanced option at the time of import.
