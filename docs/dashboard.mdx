...
The User Activity page is the most straightforward way to debug a user's recent locations and events. Navigate to the [Users page](https://radar.io/dashboard/users) and select *View* within the desired user row. Then, click *View Activity*. Filter the user's recent activity down to the minute to investigate why events did or did not fire, and understand [confidence levels](https://radar.io/documentation/geofences#confidence-and-accuracy) for events in real-world scenarios.
