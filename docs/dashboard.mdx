...
### MTU and API Usage Gauge
The MTU and API usage gauge is recalculated nightly and reflects the total 'monthly tracked users' and API requests made in that month. 

![Usage gauge](/img/widgets/usage_gauge.png)
