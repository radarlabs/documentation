...
The Pinpoint integration is available on the [Enterprise](https://radar.io/dashboard/pricing) plan.
...
`insights.state.home` | `RadarInsightsStateHome` | array[string] | `["false"]` | [Insights](/insights)
`insights.state.office` | `RadarInsightsStateOffice` | array[string] | `["false"]` | [Insights](/insights)
`insights.state.traveling` | `RadarInsightsStateTraveling` | array[string] | `["true"]` | [Insights](/insights)
