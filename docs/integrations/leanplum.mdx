...
<Alert alertType="info">
  The Leanplum integration is available on the {` `}
...
Then, on the Radar [Integrations page](https://radar.com/dashboard/integrations) under *Leanplum*, set *Enabled* to *Yes* and paste the app ID and API keys. The Radar *Test* environment automatically maps to the *Development* environment in Leanplum, and the Radar *Live* environment automatically maps to the *Production* environment in Leanplum.
