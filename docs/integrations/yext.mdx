...
<Alert alertType="info">
  The Yext integration is available on the {` `} 
...
On the Radar [Integrations page](https://radar.com/dashboard/integrations) under *Yext*, set *Enabled* to *Yes* and optionally configure any additional settings.
...
### Syncing Data
Once configured, click *Connect & Sync* and you will be redirected to Yext, where you can authorize Radar. Then, you will be redirected back to the Radar [Integrations page](https://radar.com/dashboard/integrations) with an indication of whether the authorization succeeded or failed.  If the authorization succeeded, your Yext locations will immediately begin syncing to Radar [geofences](/geofences).
