...
6. Double click on this new **Filter users** node. Where it says *Choose a property*, select *Contact Property*. Type in *radarGeofenceTags*, and set it equal to the tag you created in step one and verified in step two. Click **Update Node**.
