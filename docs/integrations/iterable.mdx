...
Then, on the Radar [Integrations page](https://radar.com/dashboard/integrations) under *Iterable*, set *Enabled* to *Yes* and paste your key. Note that you can set separate keys for the *Test* and *Live* environments.
