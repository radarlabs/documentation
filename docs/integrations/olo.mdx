...
## Olo Expo
Radar can also automatically sends status updates to Olo Expo based on Radar trip events. This keeps in-store teams up to date with latest updates on digital orders.
