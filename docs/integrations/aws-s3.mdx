...
|-------|---------|-----------------|
| Foo | Bar | The container to render the map into. You can specify an `id` of an HTML element or a DOM element. If an `<input>` is provided as a container, the style of the input will not be modified. |
