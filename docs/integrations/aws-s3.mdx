...
### Create a bucket
Create an S3 bucket for Radar to deliver data to, for example, `s3://com.example.bucket/`. Data will be delivered to `s3://com.example.bucket/events/project=$PROJECT/dt=YYYY-MM-DD/X.parquet.snappy`
