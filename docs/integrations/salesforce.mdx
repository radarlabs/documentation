...
`geofence.metadata` | `geofenceMetadata` | string | `'{"parking":false}'`
...
`place.chain.metadata` | `placeChainMetadata` | string | `'{"parking":false}'`
...
`trip.metadata` | `tripMetadata` | string | `'{"Car Model":"Green Honda Civic"}'`
...
`beacon.metadata` | `beaconMetadata` | string | `'{"type":"parking"}'`
`confidence` | `confidence` | string | `"high"`
