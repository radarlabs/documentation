...
The Segment integration is available on the [Team](https://radar.io/dashboard/pricing) plan or higher.
...
`user.entered_home` | [Insights](/insights) | `Home Entered`
`user.exited_home` | [Insights](/insights) | `Home Exited`
`user.entered_office` | [Insights](/insights) | `Office Entered`
`user.exited_office` | [Insights](/insights) | `Office Exited`
`user.started_traveling` | [Insights](/insights) | `Traveling Started`
`user.stopped_traveling` | [Insights](/insights) | `Traveling Stopped`
