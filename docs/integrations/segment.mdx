...
Then, on the Radar [Integrations page](https://radar.com/dashboard/integrations) under *Segment Source*, set *Enabled* to *Yes* and paste your write key. Note that you can set separate write keys for the *Test* and *Live* environments.
