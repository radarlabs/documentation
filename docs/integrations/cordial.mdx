...
Radar User Field | Cordial User Attribute | Type | Example Value | Context Type
--- | --- | --- | --- | ---
`userId` | `radar_external_id` | string | `"1"` |
`location.coordinates[0]` | `current_location.longitude` | number | `-76.350663` |
`location.coordinates[1]` | `current_location.latitude` | number | `39.525665` |
...
Radar Event Field | Cordial Event Attribute | Type | Example Value
--- | --- | --- | ---
...
Radar Event Attribute | Cordial Event Attribute | Type | Example Value
--- | --- | --- | ---
