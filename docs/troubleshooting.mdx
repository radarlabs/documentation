...
3. Implement Radar.trackOnce() on application launch and log the status in the completion handler/callback. Reference the associated SDK’s foreground tracking documentation section for an explanation of status values.
