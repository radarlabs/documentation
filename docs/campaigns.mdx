...
React Native developers should either implement the native iOS handling of the deep link in their app or use plugins provided by their react native navigation library of choice.

### Android
Opening the notification will result in running a pending intent that opens the configured deep link URL. This will open the URL in the app if it is registered for the scheme, or open the URL in the browser if it is not. Developers should handle this by [configuring deep link for the app](https://developer.android.com/training/app-links/deep-linking)
React Native developers should either implement the native Android handling of the deep link in their app or use plugins provided by their react native navigation library of choice.
