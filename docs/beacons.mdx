...
To create a beacon via the dashboard, go to the [Beacons page](https://radar.com/dashboard/beacons) and click the _New_ button. Enter a description, type, tag, external ID, UUID, major, minor, optional metadata, and a latitude and longitude. Click _Create_ to create the beacon.
