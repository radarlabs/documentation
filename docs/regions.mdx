...
Regions supports state detection in the US and Canada only. Each state has a `name`, a unique 2-letter `code`, and the residing `country`. View the [full list of states](/regions/states).
