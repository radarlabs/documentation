...
With Coarse Insights, you can leverage home region and traveling detection on global regions. To enable, contact your customer success manager.
...
The first time a user is tracked, the determined regions are added to the list of recent home regions. This list comprises the past 30 days in which at least one track call was made for the respective user. The most frequently occurring entry is then set as the user's home regions.
