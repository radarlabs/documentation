...
Regions is available on the [Team](https://radar.com/pricing) plan and higher.
...
Regions supports state detection in the US only. Each state has a `name` and a unique 2-letter `code`. View the [full list of states](/regions/states).
